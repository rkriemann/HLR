...
program_main ()
{
    ...
    #if defined(HAS_ZFP)
    const uint  zfp_ub = ( cmdline::eps <= 1e-10 ? 36
                           : cmdline::eps <= 1e-8 ? 30
                           : cmdline::eps <= 1e-6 ? 30
                           : cmdline::eps <= 1e-4 ? 26
                           : 20 );
        
    const uint  zfp_lb = ( cmdline::eps <= 1e-10 ? 46
                           : cmdline::eps <= 1e-8 ? 36
                           : cmdline::eps <= 1e-6 ? 22
                           : cmdline::eps <= 1e-4 ? 14
                           : 8 );
    ...
    if ( true )
    {
        ...
        if ( within( cmdline::eps, 1e-9, 1e-12 ) ) run_posit< 46, 3 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-9, 1e-11 ) ) run_posit< 44, 3 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-9, 1e-10 ) ) run_posit< 42, 3 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-9, 1e-10 ) ) run_posit< 40, 2 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-9, 1e-10 ) ) run_posit< 38, 2 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-8, 1e-10 ) ) run_posit< 36, 2 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-8, 1e-9 ) ) run_posit< 34, 2 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-7, 1e-9 ) ) run_posit< 32, 2 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-5, 1e-8 ) ) run_posit< 30, 2 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-4, 1e-6 ) ) run_posit< 28, 2 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-4, 1e-6 ) ) run_posit< 26, 2 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-4, 1e-6 ) ) run_posit< 24, 2 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-4, 1e-6 ) ) run_posit< 22, 2 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-0, 1e-4 ) ) run_posit< 20, 2 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-0, 1e-4 ) ) run_posit< 18, 2 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-0, 1e-4 ) ) run_posit< 16, 2 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-0, 1e-4 ) ) run_posit< 16, 1 >( *A_ref, *A, normA );
        if ( within( cmdline::eps, 1e-0, 1e-4 ) ) run_posit< 14, 1 >( *A_ref, *A, normA );
    }// if
    #endif
...

    {
        ...
        if ( true )
        {
            ...
            if ( within( cmdline::eps, 1e-9, 1e-12 ) ) run_posit< 46, 3 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-9, 1e-11 ) ) run_posit< 44, 3 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-9, 1e-10 ) ) run_posit< 42, 3 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-9, 1e-10 ) ) run_posit< 40, 2 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-9, 1e-10 ) ) run_posit< 38, 2 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-8, 1e-10 ) ) run_posit< 36, 2 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-8, 1e-9 ) ) run_posit< 34, 2 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-7, 1e-9 ) ) run_posit< 32, 2 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-5, 1e-8 ) ) run_posit< 30, 2 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-4, 1e-6 ) ) run_posit< 28, 2 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-4, 1e-6 ) ) run_posit< 26, 2 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-4, 1e-6 ) ) run_posit< 24, 2 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-4, 1e-6 ) ) run_posit< 22, 2 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-0, 1e-4 ) ) run_posit< 20, 2 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-0, 1e-4 ) ) run_posit< 18, 2 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-0, 1e-4 ) ) run_posit< 16, 2 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-0, 1e-4 ) ) run_posit< 16, 1 >( *A_ref, *A2, *rowcb, *colcb, normA );
            if ( within( cmdline::eps, 1e-0, 1e-4 ) ) run_posit< 14, 1 >( *A_ref, *A2, *rowcb, *colcb, normA );
        }// if
        #endif
    }
