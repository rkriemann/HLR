...
template < typename value_t,
           typename approx_t >
blas::matrix< value_t >
compute_updated_row_basis ( const hpro::TBlockMatrix &           M,
                            const uint                           i,
                            const uint                           j,
                            const blas::matrix< value_t > &      W,
...
template < typename value_t,
           typename approx_t >
blas::matrix< value_t >
compute_updated_col_basis ( const hpro::TBlockMatrix &           M,
                            const uint                           i,
                            const uint                           j,
                            const blas::matrix< value_t > &      T,
                            const blas::matrix< value_t > &      X,
...
template < typename value_t,
           typename approx_t >
void
update_row_basis ( hpro::TBlockMatrix &             M,
                   const uint                       i,
                   const uint                       j,
                   const blas::matrix< value_t > &  W,
                   const blas::matrix< value_t > &  T,
...
template < typename value_t,
           typename approx_t >
void
update_col_basis ( hpro::TBlockMatrix &             M,
                   const uint                       i,
                   const uint                       j,
                   const blas::matrix< value_t > &  T,
                   const blas::matrix< value_t > &  X,
...
template < typename value_t,
           typename approx_t >
void
update_row_col_basis ( hpro::TBlockMatrix &             M,
                       const uint                       i,
                       const uint                       j,
                       const blas::matrix< value_t > &  W,
                       const blas::matrix< value_t > &  T,
