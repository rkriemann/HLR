...
namespace hlr { namespace dag { namespace lu { namespace accu {
...
struct accumulator
{
    using  accumulator_map_t  = std::map< Hpro::id_t, accumulator >;
...
template < typename value_t,
           typename approx_t >
using  apply_map_t        = std::map< Hpro::id_t, apply_node< value_t, approx_t > * >;
