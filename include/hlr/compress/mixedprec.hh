            ...
            value_t *        y )
{
    ...
    const uint32_t  n_fp16 = reinterpret_cast< const uint32_t * >( zA.data() )[2];
    ...
    switch ( op_A )
    {
        case  apply_normal :
        {
            ...
            if ( n_fp16 > 0 )
            {
                ...
                mulvec< value_t, fp16_t >( nrows, n_fp16, op_A, alpha, zptr, x + pos, y );
        ...
        case  apply_adjoint :
        {
            ...
            if ( n_fp16 > 0 )
            {
                ...
                mulvec< value_t, fp16_t >( nrows, n_fp16, op_A, alpha, zptr, x, y + pos );
                zpos += n_fp16 * nrows * sizeof(fp16_t);
                pos  += n_fp16;
            }// if
        }// case
