...
//
inline byte_t eps_to_rate      ( const double  eps ) { return std::max< double >( 1, std::ceil( -std::log2( eps ) ) ) + 2; }
inline byte_t eps_to_rate_aplr ( const double  eps ) { return std::max< double >( 1, std::ceil( -1.1 * std::log2( eps ) ) ) + 5; }
